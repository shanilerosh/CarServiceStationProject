...
public class PaymentController implements Initializable {
    ...
    private void btnAddPayment_OnAction(ActionEvent event) throws ClassNotFoundException, SQLException, FileNotFoundException, JRException {
        ...
        if (txtSupplierName.getText().isEmpty()) {
            ...
            if (sup == null) {
                ...
                if (isAdded) {
                    tblPaymentData.getItems().add(new PaymentTableModel(txtPayId.getText(), txtSupplierName.getText(),
                            comboPaymentType.getSelectionModel().getSelectedItem(),
                            LocalDate.now().format(DateTimeFormatter.ISO_DATE),
                            Double.parseDouble(txtAmount.getText()),
                            txtSupplierInvoiceNumbers.getText()
    ...
    private void clearFields() throws ClassNotFoundException, SQLException {
    ...
    @FXML
    private void btnReset_onAction(ActionEvent event) throws ClassNotFoundException, SQLException {
